// Centralized CRM API types derived from backend swagger
...
export interface CustomOrderFieldSchema {
    id: string
    label: string
...
export interface OrgSettings {
    ...
    custom_order_fields_schema?: string | CustomOrderFieldSchema[]
    created_at?: string
    updated_at?: string
}
...
export type MessageStatus = "queued" | "sent" | "delivered" | "failed" | "cancelled"
...
export type CreateTemplatePayload = Omit<MessageTemplate, "id" | "org_id" | "created_at" | "updated_at">
export type UpdateSettingsPayload = Partial<OrgSettings>
